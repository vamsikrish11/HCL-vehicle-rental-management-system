const loginBaseurl="http://localhost:3000/api/v1/login";
...
const nullUserName=document.getElementById("EnterUserName");

userName.addEventListner('blur',function(event){
    if(event.target.value===""){

nullUserName.style.color='black';
    }
})